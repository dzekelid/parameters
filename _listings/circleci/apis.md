...
- name: CircleCI
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/parameters/master/_listings/circleci/project-username-project-build-num-artifacts-parameters.md
x-common:
- type: x-blog
